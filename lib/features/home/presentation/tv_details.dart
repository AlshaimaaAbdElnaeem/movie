...
class TvDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => TvCubit()..fetchTvDetails(tvId),
      child: Scaffold(
        body: SafeArea(
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            state.tvDetails.genres!.map((genre) => genre.name).join(', '),
                          ...
                          Text(
                            state.tvDetails.overview ?? 'No overview available.',
                            textAlign: TextAlign.start,
                            maxLines: 5,
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(
                          ...
                          SizedBox(
                            ...
                            child: Row(
                              ...
                              children: [
                                CustomFinalData(text: state.tvDetails.languages!.join(', '),),
                                CustomFinalData(text: '${state.tvDetails.episodeRunTime} Min',),
                                CustomFinalData(text: '${state.tvDetails.voteAverage} ⭐',),
                                CustomFinalData(text:state.tvDetails.numberOfSeasons.toString(),),
                              ],
                            )
                          ),
                        ],
